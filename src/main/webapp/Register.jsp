	...
	<div class="login-form">
		...
		<form>
			<input type="text" class="text" value="邮箱" onFocus="this.value = '';"
				...
				type="text" class="text" value="姓名" onFocus="this.value = '';"
				onBlur="if (this.value == '') {this.value = '姓名';}"> <input
				type="text" class="text" value="身份证" onFocus="this.value = '';"
				onBlur="if (this.value == '') {this.value = '身份证';}"> <input
				type="text" class="text" value="用户名" onFocus="this.value = '';"
